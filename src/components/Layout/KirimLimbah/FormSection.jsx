...
const Form = () => {
    ...
    <div className="px-[200px] pt-[75px] text-grey-800 flex flex-col items-center gap-[65px]">
        ...
        <div className="flex justify-between gap-[8em]">
            <div className="pr-4 w-[669px]">
                <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        ></textarea>
                        <span className="flex items-center gap-[5px] text-xs text-gray-500"> <FontAwesomeIcon icon={faCircleExclamation} />Minimum penukaran adalah 0.5 kg</span>
                    </div>
                    ...
                    <span className="flex items-center gap-[5px] text-xs text-gray-500"><FontAwesomeIcon icon={faCircleExclamation} /> Hanya limbah organik</span>
                </div>
            </div>
            <div className="w-1/3 pl-4">
                <div className="mb-4 flex flex-col items-center grid-gap: 0.5em w-max-conten">
                    ...
                    <span className="flex items-center gap-[5px] text-xs text-gray-500"><FontAwesomeIcon icon={faCircleExclamation} /> Ukuran Gambar Maksimal 5 MB</span>
                </div>
                {imageSelected && (
                <div className="flex items-center gap-2">
                    <img src={imagePreview} alt="Preview" className="mt-2 rounded-md" style={{ maxWidth: '100px' }} />
                    <button
        ...
        <Link to="/halaman-tujuan">
            <label htmlFor="submit" className="flex justify-center w-[800px] px-4 py-[5px] cursor-pointer text-gray-50 hover:text-gray-200 active:text-gray-400 bg-primary-600 hover:bg-tertiary-600 active:bg-tertiary-800 transition duration-300 rounded-full">
                Tukar Ratik
            </label>
        </Link>
        </div>
